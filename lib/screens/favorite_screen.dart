...
class _ImageScreenState extends State<ImageScreen> {
  String _imageUrl = 'http://10.0.2.2:8000/api/image-with-text/'; // 이미지 URL을 저장할 변수

  // 서버로부터 이미지 URL을 가져오는 함수
  Future<void> fetchImageUrl() async {
    var uri = Uri.parse('http://10.0.2.2:8000/api/image-with-text/'); // 이미지 URL을 제공하는 서버의 API 주소
