...
const String serverBaseURL = 'http://10.0.2.2:8000'; // 서버 주소 변경 가능
    ...
    child: Column(
      children: <Widget>[
        ...
        Card(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Image.network(imageResponse.secondModelImageUrl ?? 'http://10.0.2.2:8000/media/license_plate_images/license_plate_image_CqsX5tJ.png'),
          ),
        ),
        SizedBox(height: 10),
        // 번호판 이미지 URL
        Card(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Image.network(imageResponse.licensePlateImageUrl ?? 'http://10.0.2.2:8000/media/license_plate_images/license_plate_image_CqsX5tJ.png'),
          ),
        ),
        SizedBox(height: 10),
        // 정보 카드
