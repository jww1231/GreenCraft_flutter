...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _fetchFaqList() async {
    final url = 'http://10.0.2.2:8080/api/faq'; // 서버 API URL
    try {
  ...
  Future<void> _updateFaq(int index) async {
    final url = 'http://10.0.2.2:8080/api/faq/${_faqList[index]['no']}';
    try {
            ...
            children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          onPrimary:
                              Colors.black, // 여기에서 버튼의 텍스트 색상을 흰색으로 설정합니다.
                        ),
                        child: Text('Add FAQ'),
                      ),
                    ),
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  String faqTitle =
                      "${_faqList[index]['no']}번 - ${_faqList[index]['question']}";
                  return Card(
                    // Card 위젯으로 감쌉니다.
                    elevation: 4.0, // 카드의 그림자 깊이를 설정합니다.
                    margin: EdgeInsets.symmetric(
                        vertical: 8.0), // 카드 사이의 간격을 설정합니다.
                    child: ListTile(
                      title: Text(faqTitle),
